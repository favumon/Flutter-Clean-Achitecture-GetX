...
// in data/test/core/utils/dio_interceptors/retry_interceptor_test.dart.
...
import 'package:dio/src/dio_error.dart' as _i14;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockDioError extends _i1.Mock implements _i14.DioError {
  MockDioError() {
    _i1.throwOnMissingStub(this);
  }
  ...
  set response(_i6.Response<dynamic>? _response) =>
      super.noSuchMethod(Invocation.setter(#response, _response),
          returnValueForMissingStub: null);
  @override
  _i14.DioErrorType get type => (super.noSuchMethod(Invocation.getter(#type),
      returnValue: _i14.DioErrorType.connectTimeout) as _i14.DioErrorType);
  @override
  set type(_i14.DioErrorType? _type) =>
...
class MockErrorInterceptorHandler extends _i1.Mock
  ...
  void resolve(_i6.Response<dynamic>? response) =>
      super.noSuchMethod(Invocation.method(#resolve, [response]),
          returnValueForMissingStub: null);
  @override
  void reject(_i14.DioError? error) =>
...
class MockResponse<T> extends _i1.Mock implements _i6.Response<T> {
  ...
  List<_i15.RedirectRecord> get redirects =>
      (super.noSuchMethod(Invocation.getter(#redirects),
          returnValue: <_i15.RedirectRecord>[]) as List<_i15.RedirectRecord>);
  @override
  set redirects(List<_i15.RedirectRecord>? _redirects) =>
...
class MockRequestOptions extends _i1.Mock implements _i2.RequestOptions {
  ...
  set path(String? _path) => super.noSuchMethod(Invocation.setter(#path, _path),
      returnValueForMissingStub: null);
  @override
  set cancelToken(_i10.CancelToken? _cancelToken) =>
